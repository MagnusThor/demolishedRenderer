...
exports.AP = exports.Note = void 0;
exports.Note = {
    107: 7902.13,
    106: 7458.62,
    105: 7040.0,
...
class AP {
    ...
    play() {
        ...
        this.song.channels.forEach(channel => {
            ...
            channel.sequence.forEach((pattern, patternIndex) => {
                []
                    ...
                    instrument: 1,
                    notes: []
                }, channel.patterns)[pattern].notes.forEach(note => {
                    note.pitches.forEach(pitch => {
                        let [start, stop] = note.points;
                        if (!exports.Note[pitch]) {
                            return;
                        }
                        ...
                        let node = this.note(exports.Note[pitch], noteDuration, noteDelay, instrument.wave, 0.1);
                        if (!largestTime) {
                            largestTime = end;
                        }
                        if (!lastNode) {
        ...
        return AP.generateNode(notes, last);
    }
    loop() {
        let node = this.play();
        if (node.last) {
