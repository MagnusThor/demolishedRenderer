...
const runner = () => {
    ...
    dr.aB("iChannel0", mainVertex_1.mainVertex, bufferB_1.bufferBFragment.C()); // bufferA 0
    dr.aB("iChannel1", mainVertex_1.mainVertex, bufferC_1.bufferCFragment.C()); // bufferB 1
    dr.aB("iChannel2", mainVertex_1.mainVertex, bufferD_1.bufferDFragment.C()); // bufferC 2
    dr.aB("iChannel3", mainVertex_1.mainVertex, bufferA_1.bufferAFragment.C()); // bufferC 2  
    dr.aB("iChannel4", mainVertex_1.mainVertex, bufferE_1.bufferEFragment.C()); // bufferA 0
