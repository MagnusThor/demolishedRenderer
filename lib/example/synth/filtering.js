...
exports.warpInfinityToNyquist = exports.warpNyquistToInfinity = exports.DynamicBiquadFilter = exports.FrequencyResponse = exports.FilterCoefficients = void 0;
...
function warpNyquistToInfinity(radians) {
    return 2.0 * Math.tan(radians * 0.5);
}
exports.warpNyquistToInfinity = warpNyquistToInfinity;
function warpInfinityToNyquist(radians) {
    return 2.0 * Math.atan(radians * 0.5);
}
exports.warpInfinityToNyquist = warpInfinityToNyquist;
