"use strict";
var DemolisedBuffers = /** @class */ (function () {
    function DemolisedBuffers(canvas, v, f) {
        this.canvas = canvas;
    ...
    DemolisedBuffers.prototype.createShader = function (program, type, source) {
    ...
    DemolisedBuffers.prototype.addProgram = function (name) {
        var p = this.gl.createProgram();
        this.programs.set(name, p);
        return p;
    };
    DemolisedBuffers.prototype.ct = function (image) {
        var gl = this.gl;
    ...
    DemolisedBuffers.prototype.addAssets = function (textures, cb) {
        var _this = this;
    ...
    DemolisedBuffers.prototype.addBuffer = function (name, vertex, fragment, textures) {
        var _this = this;
        var gl = this.gl;
    ...
    DemolisedBuffers.prototype.render = function (time) {
        var _this = this;
        var gl = this.gl;
    ...
    DemolisedBuffers.prototype.createTarget = function (width, height, textures) {
        var gl = this.gl;
        var t = {
